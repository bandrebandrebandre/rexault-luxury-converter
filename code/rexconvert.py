...
#include <avr/pgmspace.h>
    ...
    print "row_size_in_bytes: " + str(row_size_in_bytes)

    for y in range(0, len(bin_array)):
        for byte in range(0, row_size_in_bytes):
            print str(bin_array[y][0:9])
           # print str(bin_array[y][byte*8:(byte+1)*8])



#            hexified = hex(int(bin_array[y][(byte * 8):min(((byte+1) * 8), image.shape[1])], 2)).upper()
